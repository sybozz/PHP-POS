...
<script>
    ...
    $(function() {
        $("[name='salepoints_item_code']").focus();
    });
    ...
    <div class="container clear_both padding_fix">
        <section class="panel panel-default">
            <div class="panel-body">
                <div class="row">
                        ...
                        <div class="block-web">
                            ...
                            <div class="porlets-content">
                                <form action=""  method="post" class="form-horizontal row-border">
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control" name="salepoints_item_code" id="salepoints_item_code" placeholder="Item Code">
                                    </div><!--/form-group-->
                                    <div class="form-group">
                                        <input type="text" class="form-control" name="pointsitemName" placeholder="Search by Item name">
                                    </div><!--/form-group-->
                                    <div class="form-group">
                                        <span id="Pstock_empty"></span>
                                        <div id="itemShow" style="width:100%;border:1px solid #ccc;height:auto;">
                                            <select id="salepoints_item_show" size="20" style="height:270px!important; width:100%;">
                    ...
                    <div class="col-md-5">
                        <div class="block-web">
                            ...
                            <div class="porlets-content">
                                <form action=""  method="post" id="salepoints_item_form" class="form-horizontal row-border">

                                    <!--select info-->
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label"> 
                                            <span id="salepoints_item_photo"><img src="images/itemimages/no_image.png" style="width:100%;" /></span>
                                        </label>
                                        <div class="col-sm-5">
                                            <span style="font-size:16px;font-weight:bold;" id="salepoints_item_name">Product Name</span><br> 
                                            <span id="salepoints_item_barcode"></span>
                                            Category: <span id="salepoints_item_catname"></span><br>
                                            <span style="font-size:11px;line-height:15px;color:#334559;" id="salepoints_item_des">Product Description</span><br>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" name="salepoints_price" required placeholder="0.00" onkeypress="return OnlyNumberKey(event);" readonly>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" readonly class="form-control" name="salepoints_discount" placeholder="0.00" onkeypress="return OnlyNumberKey(event);">
                                        </div>

                                    </div><!--/form-group-->  
                                    <div class="form-group">
                                        <label class="col-sm-4 control-label">Available Qty. (<span name="salepoints_item_unit"></span>)</label>
                                        <div class="col-sm-4">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-4 control-label">Quantity (<span name="salepoints_item_unit"></span>)</label>
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control"  name="salepoints_quantity" required  value="1" onkeypress="return OnlyNumberKey(event);">
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" name="salepoints_subtotal_price" readonly placeholder="0.00" onkeypress="return OnlyNumberKey(event);">
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="button" style="display:none;" name="salepoints_item_update" value="Item Update" class="btn btn-primary">
                                            <input type="button" style="display:none;" name="salepoints_item_cancel" value="Cancel" class="btn btn-primary">
                                            <input type="submit" name="salepoints_item_add" value="Item Add" class="btn btn-primary">

                                            <input type="hidden"  name="salepoints_tr_index" value="">
                                            <input type="hidden" name="salepoints_item_id" value="">
                                        </div>
                                    </div><!--/form-group-->
                    ...
                    <div class="col-md-4">
                        <div class="block-web">
                            ...
                            <div class="porlets-content">
                                <form action="" id="item_salepoints_form"  method="post" class="form-horizontal row-border">
                                    <div class="form-group">
                                        <label style="text-align:left;" class="col-sm-4 control-label">Customer</label>
                                        <div class="col-sm-8">
                                            <select class="form-control" id="pointscus_id_dis" name="cus_id" required >
                                    ...
                                    <div class="form-group">
                                        <label style="text-align:left;" class="col-sm-4 control-label">Customer Points</label>
                                        <div class="col-sm-5">
                                            <input type="text" readonly class="form-control" name="customer_points" placeholder="0.00">
                                        </div>
                                    </div><!--/form-group-->

                                    <div class="form-group">
                                        <label style="text-align:left;" class="col-sm-4 control-label">Points</label>
                                        <div class="col-sm-5">
                                            <input type="text"  class="form-control" name="points_app" placeholder="0.00" required onkeypress="return OnlyNumberKey(event);">
                                        </div>
                                    </div><!--/form-group-->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-5">
                                            <input type="text" readonly class="form-control" name="salepoints_total_price" placeholder="0.00">
                                        </div>
                                    </div><!--/form-group-->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-5">
                                            <input type="text" class="form-control" readonly id="abcd" name="salepoints_net_payable" placeholder="0.00" >
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label style="text-align:left;" class="col-sm-4 control-label"><b>Amt.</b></label>
                                        <div class="col-sm-5">
                                            <input type="text" class="form-control" name="trans_amt1"  onkeypress="return OnlyNumberKey(event);" placeholder="0.00" >
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-5">
                                            <input type="text" class="form-control" name="salepoints_amt_due" readonly value="0.00" ><br>
                                            <input type="submit" name="salepoints_item_insert" value="sale" class="btn btn-primary">
                                        </div>
                                    </div>
                ...
                <table class="table table-hover" id="salepoints_item_table">
                    <thead>
                        <tr>
...
<a style="line-height:15px!important;background:#f00;" class="btn btn-primary" href="">Remove</a></td>
                        ...
                        <tr>
                            ...
                            <td><strong><span id="salepoints_total_price">0.00</span></strong></td>
