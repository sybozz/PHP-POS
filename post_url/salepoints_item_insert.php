<?php
	...
	echo $cls_points->salepoints_insert($user_id, $result, $cus_id, $points_app, $inovice_num, $sale_total_price, $total_vat, $total_discount, $rounding_amt, $sale_net_payable, $pay_type1,  $trans_num1, $trans_amt1, $pay_type2, $trans_num2, $trans_amt2, $return_amt, $sale_amt_due);
