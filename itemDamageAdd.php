    ...
    <div class="contentpanel">
      ...
      <div class="pull-left breadcrumb_admin clear_both">
        <div class="pull-left page_title theme_color">
          <h1>Items</h1>
          <h2 class="">Add Damage Items Form</h2>
        </div>
        ...
        <div class="col-md-6">
          <div class="block-web">
            <div class="header">
              ...
              <h3 class="content-header">Add Damage Items Form</h3>
            </div>
            <div class="porlets-content">
               <form action=""  method="post" id="damage_add" class="form-horizontal row-border" enctype="multipart/form-data"> 
               ...
               <div class="form-group">
				...
				<div class="form-group">
                  ...
                  <div class="col-sm-9">
                   <input type="text" class="form-control" name="damage_qnty" required />
                  </div>
                </div><!--/form-group-->
